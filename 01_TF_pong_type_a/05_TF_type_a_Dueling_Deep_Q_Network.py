...
class DQN_agent:
    ...
    def build_model(self, network_name):
        ...
        with tf.variable_scope(network_name):
            ...
            net_15_state = tf.layers.dense(model, 512, activation=tf.nn.relu)
            net_15_action = tf.layers.dense(model, 512, activation=tf.nn.relu)
        ...
        output = tf.add(net_16_state, net16_advantage)
...
def main():
    ...
    pylab.savefig("./save_graph/pong_duelingdqn.png")
